...
class Work_experienceController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('auth.page.work _experience.manage_work_experience',compact('work_experience'));
    }
    ...
    {
        return view('auth.page.work _experience.create_work_experience');
    }
    ...
    public function edit($id)
    {
        ...
        return view('auth.page.work _experience.edit_work_experience', compact('work_experience'));
