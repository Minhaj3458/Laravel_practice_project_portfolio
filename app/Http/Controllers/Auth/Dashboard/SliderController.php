...
class SliderController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('auth.page.slider.manage_slider',compact('slider'));
    }
    ...
    {
        return view('auth.page.slider.create_slider');
    }
    ...
    {   
        ...
        // $destinationPath = public_path('assets/frontend/images/profile/')->save($image_name);
        // $Image_resize = Image::make($file)->resize(250,250)->save($destinationPath.$image_name);
        }
        ...
        // $destinationPath = public_path('assets/frontend/images/slider/');
        // $Image_resize = 
        // Image::make($file)->resize(1350,600)->save($destinationPath.$slider_name);
        }
        ...
        $cv_name =$image_get_name.time().'.'.$extention;
    ...
    public function edit($id)
    {
        ...
        return view('auth.page.slider.edit_slider',compact('slider'));
    }
