...
class ReferencesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('auth.page.Reference.manage_reference',compact('reference'));
    ...
    {
       return view('auth.page.Reference.create_reference');
    }
    ...
    public function edit($id)
    {
        ...
        return view('auth.page.Reference.edit_reference',compact('reference'));
    }
