...
namespace App\Http\Controllers\Auth\Dashboard\Portfolio;
...
class Portfolio_experience3Controller extends Controller
{
    ...
    public function index()
    {
       ...
       return view('auth.page.portfolio.portfolio_experience3.manage_port_exper3',compact('port_exper3')); 
    }
    ...
    {
       return view('auth.page.portfolio.portfolio_experience3.create_pro_exp3');
    }
    ...
    public function edit($id)
    {
       ...
       return view('auth.page.portfolio.portfolio_experience3.edit_port_exper3',compact('port_exper3'));
    }
