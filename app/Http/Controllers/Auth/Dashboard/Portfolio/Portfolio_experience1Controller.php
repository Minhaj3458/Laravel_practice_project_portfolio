...
class Portfolio_experience1Controller extends Controller
{
    ...
    public function index()
    {
       ...
       return view('auth.page.portfolio.portfolio_experience1.manage_port_exper1',compact('port_exper1'));
    }
    ...
    {
        return view('auth.page.portfolio.portfolio_experience1.create_pro_exp1');
    }
    ...
    public function edit($id)
    {
       ...
       return view('auth.page.portfolio.portfolio_experience1.edit_port_exper1',compact('port_exper1'));
    }
