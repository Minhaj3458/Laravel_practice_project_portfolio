...
class Portfolio_experience2Controller extends Controller
{
    ...
    public function index()
    {
       ...
       return view('auth.page.portfolio.portfolio_experience2.manage_port_exper2',compact('port_exper2'));
    }
    ...
    {
        return view('auth.page.portfolio.portfolio_experience2.create_pro_exp2');
    }
    ...
    public function edit($id)
    {
       ...
       return view('auth.page.portfolio.portfolio_experience2.edit_port_exper2',compact('port_exper2'));
    }
