...
class EducationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('auth.page.education.manage_education', compact('education'));
    }
    ...
    {
       return view('auth.page.education.create_education');
    }
    ...
    public function edit($id)
    {
        ...
        return view('auth.page.education.edit_education', compact('education'));
    }
