...
@section('Content_header')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Create Portfolio Experience3</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Create Portfolio Experience3</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Portfolio Experience3</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{ route('store_port_exp3') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-block btn-outline-primary">Create Portfolio Experience3</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
