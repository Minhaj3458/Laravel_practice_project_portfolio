...
@section('Content_header')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Work Exprience</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Update Work Exprience</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Work Exprience</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{ route('update_work_exper', $work_experience ->id ) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Work Experience Name</label>
                    <input type="text" name="work_experienceName" class="form-control"  id="exampleInputEmail1" value="{{ $work_experience ->work_experienceName }}" maxlength="45" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="work_place" class="form-control"  id="exampleInputEmail1" value="{{ $work_experience ->work_place }}" maxlength="15" required>
                  ...
                  <div class="form-group">
                    ...
                    {{ $work_experience->short_description }}
                     </textarea>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-block btn-outline-primary">Update Work Exprience</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
